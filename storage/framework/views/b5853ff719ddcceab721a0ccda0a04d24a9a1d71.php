            ...
            <div class="card author-box card-primary">
                <div class="card-body">
                    ...
                    <div class="author-box-name">
                        ...
                        <a href="<?php echo e(route('projects.show',[$currantWorkspace->slug,$project->id])); ?>" title="<?php echo e($project->name); ?>" class="text-title"><?php echo e($project->name); ?></a>
                    ...
                    <div class="float-right mt-sm-0 mt-3">
                        <a href="<?php echo e(route('projects.show',[$currantWorkspace->slug,$project->id])); ?>" class="btn btn-sm btn-primary"><?php echo e(__('View More')); ?> <i class="dripicons-arrow-right"></i></a>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\task_manager\resources\views/projects/index.blade.php ENDPATH**/ ?>