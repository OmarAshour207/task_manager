<aside id="sidebar-wrapper">
  <div class="sidebar-brand">
    <a href="<?php echo e(route('home')); ?>">
        <img src="<?php echo e(asset(Storage::url('logo/default.png'))); ?>" alt="<?php echo e(env('APP_NAME')); ?>" height="35">
    </a>
  </div>
  <div class="sidebar-brand sidebar-brand-sm">
    <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset(Storage::url('logo/default.png'))); ?>" alt="<?php echo e(env('APP_NAME')); ?>" height="25"></a>
  </div>
...
<?php /**PATH C:\laragon\www\task_manager\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>